          ...
          <View className='at-article__content'>
            <View className='at-article__section'>
              ...
              <View className='at-article__p'>
                ...
                我们强烈呼吁电竞行业和相关机构能够正视这一问题，并采取措施加以解决。
              </View>
              <View className='at-article__p'>
                首先，应该加强对职业选手的心理健康教育和培训，帮助他们更好地应对压力和焦虑。其次，应该建立健全的心理咨询和疏导机制，为职业选手提供及时、有效的心理支持和帮助。同时，媒体和粉丝也应该更加理性和宽容地对待职业选手，避免过度期望和攻击，为他们创造一个更加健康、积极的竞技环境。
