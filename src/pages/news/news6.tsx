          ...
          <View className='at-article__content'>
            <View className='at-article__section'>
              ...
              <View className='at-article__p'>
                ...
                草莓作为CFPL（穿越火线职业联赛）现役唯一的女选手，在赛场上展现出了出色的实力和坚韧的精神。然而，在俱乐部内部，她却面临着如此恶劣的待遇，这不禁让人对她的处境感到担忧。
                对于这一事件，俱乐部方面尚未发表正式声明。然而，从草莓的伤势和知情人士的爆料来看，这起霸凌事件是真实存在的。电竞作为一项高度竞争的体育项目，选手们应该相互尊重、团结合作，而不是进行恶意的攻击和排挤。
                在电竞界，选手的身心健康和比赛环境一直备受关注。俱乐部作为选手们的“家”，应该为他们提供一个安全、和谐、积极的训练和比赛环境。对于这起霸凌事件，我们呼吁俱乐部方面能够尽快采取行动，保护选手的权益和利益，维护电竞圈的公平和正义。
